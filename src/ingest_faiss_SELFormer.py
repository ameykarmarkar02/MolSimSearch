...
SMILES_CSV      = os.path.join(DATA_DIR, "sample_embeddings_SELFormer.csv")
SELFIES_CSV     = os.path.join(DATA_DIR, "selfies_embeddings_SELFormer.csv")
...
if __name__ == "__main__":
    ...
    build_and_save(ids_sm, vecs_sm, "smiles_SELFormer")

    # SELFIES
    ids_sf, vecs_sf = load_and_normalize(SELFIES_CSV)
    build_and_save(ids_sf, vecs_sf, "selfies_SELFormer")
